...
public class HotelsFilter implements Parcelable
{
  ...
  public static class And extends HotelsFilter
  {
    ...
    {
      super(TYPE_AND);
      mLhs = Objects.requireNonNull(source.readParcelable(HotelsFilter.class.getClassLoader()));
      mRhs = Objects.requireNonNull(source.readParcelable(HotelsFilter.class.getClassLoader()));
    }
  ...
  public static class OneOf extends HotelsFilter
  {
    ...
    {
      super(TYPE_ONE_OF);
      mType = Objects.requireNonNull(source.readParcelable(HotelType.class.getClassLoader()));
  ...
  public static class HotelType implements Parcelable
  {
    ...
    {
      mType = in.readInt();
      mTag = Objects.requireNonNull(in.readString());
    }
